...
foreach ($contents as $content) {
    ...
    <section role="banner" class="<?php $banner_wrapper; ?> " itemscope itemtype="http://schema.org/<?php echo $itemtype;?>">
        <div <?php if ($id) {
            echo 'id="' . $id . '"';
        } ?> class="<?php $field_name; ?>  <?php $class; ?> page-banner"   style="background-color: <?php echo $highlight_one;?>"            <?php if ($content['callout_component_image']) {
                ...
                <div class="title-container">
                    ...
                    <?php if ($content['callout_component_subtitle']) { ?>
                        <div class="subtitle-title-container">
                            <h6 style="color: <?php echo $highlight_two;?>;" class="subtitle"><?php echo $content['callout_component_subtitle']; ?></h6>
                        </div>
                    <?php } ?>
                    <!-- heading -->
                    <?php if ($content['callout_component_heading']) { ?>
                        <?php echo '<' . $heading_tag . ' class="heading banner-title">' . $heading_content . '</' . $heading_tag . '>';
                    } ?>
                </div>
            </div>
