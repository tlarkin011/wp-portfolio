...
foreach ($contents as $content) {
    ...
    ?>
    <article <?= $id ? 'id=' . $id : ''; ?>
             class="content-component left-right-content <?= $field_name; ?>  <?= $class; ?>  <?= $content['style']; ?> "
            ...
            <div class="columns-6 content-column">
                ...
                <div class="text-container">
                    ...
                    <?php if ($content['callout_component_subtitle']) { ?>
                        <h6 class="subtitle"><?= $content['callout_component_subtitle']; ?></h6>
                    <?php } ?>
                    <!-- heading -->
        ...
        <?php if ($content['callout_component_image_toggle']) { ?>

            <div class="image-column columns-6">
                <img src="<?= $content['callout_component_content_image']['url']; ?>" alt="">
            </div>
